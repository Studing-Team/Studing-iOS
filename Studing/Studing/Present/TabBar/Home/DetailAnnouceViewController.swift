...
enum DetailAnnouceType {
    case bookmarkAnnouce
    case unreadAnnouce
}

final class DetailAnnouceViewController: UIViewController {
    
    // MARK: - Properties
    
    private var type: DetailAnnouceType
...
private extension DetailAnnouceViewController {
...
//        let output = detailAnnouceViewModel.transform(input: input)
    ...
    func setupHierarchy(_ type: DetailAnnouceType) {
        switch type {
        case .bookmarkAnnouce:
    ...
    func setupLayout(_ type: DetailAnnouceType) {
